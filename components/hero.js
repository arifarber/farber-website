...
import HomeImg from './homepageImage.js'
            ...
            <Container className="flex flex-wrap ">
                <div className="flex items-center w-full lg:w-1/2">
                    <div className="max-w-2xl mb-8">
                        <h1 className="text-4xl font-bold leading-snug tracking-tight text-blue-400 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
                            Ari Farber
                        </h1>
                        <p className="py-5 text-xl leading-normal text-blue-400 lg:text-xl xl:text-2xl dark:text-gray-300">
